  ...
  return <>
    <div className="wrapper">
    {
      features.map((feature , index) => (
        ...
        <button className="card-icon" style={{marginTop:'1 rem'}}
        onClick={()=> feature.title == 'Your Created ICO' ? 
        setOpenAllICO(true): feature.title== 'ICO Marketplace' ?
        ...
        feature.title == 'widthdraw Token' ? setOpenWidthdrawToken(true) :
         feature.title  == 'ICO ADDRESS' ? copyAddress() :
         feature.title === 'Create ICO' ? setOpenCreateICO(true): 
         ""
